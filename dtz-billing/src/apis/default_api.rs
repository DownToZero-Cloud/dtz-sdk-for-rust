...
pub async fn post_usage(configuration: &Configuration, usage: Option<crate::models::Usage>) -> Result<(), Error<PostUsageError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&usage);
