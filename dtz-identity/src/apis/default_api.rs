...
pub async fn authenticate_apikey(configuration: &Configuration, authenticate_apikey_request: Option<crate::models::AuthenticateApikeyRequest>) -> Result<models::TokenResponse, Error<AuthenticateApikeyError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&authenticate_apikey_request);
