...
/// oauth token request
pub async fn oauth_token(configuration: &Configuration, grant_type: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>, redirect_uri: Option<&str>, code: Option<&str>) -> Result<models::TokenResponse, Error<OauthTokenError>> {
    let local_var_configuration = configuration;
