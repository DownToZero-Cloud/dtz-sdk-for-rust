...
pub async fn create_feed(configuration: &Configuration, create_feed_request: Option<crate::models::CreateFeedRequest>) -> Result<models::CreateFeed200Response, Error<CreateFeedError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&create_feed_request);
...
pub async fn get_feed(configuration: &Configuration, feed_id: &str) -> Result<models::CreateFeed200Response, Error<GetFeedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_profile(configuration: &Configuration, ) -> Result<models::GetProfile200Response, Error<GetProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn list_feed(configuration: &Configuration, ) -> Result<(), Error<ListFeedError>> {
    let local_var_configuration = configuration;
...
pub async fn update_feed(configuration: &Configuration, feed_id: &str, create_feed200_response: Option<crate::models::CreateFeed200Response>) -> Result<(), Error<UpdateFeedError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&create_feed200_response);
