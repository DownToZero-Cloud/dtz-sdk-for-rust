...
cd dtz-core && cargo clean && cargo build && cd ..
...
cd dtz-identity && cargo clean && cargo build && cd ..
...
cd dtz-observability && cargo clean && cargo build && cd ..
...
cd dtz-containers && cargo clean && cargo build && cd ..
...
cd dtz-flows && cargo clean && cargo build && cd ..
...
cd dtz-objectstore && cargo clean && cargo build && cd ..
