...
pub async fn create_job(configuration: &Configuration, create_job_request: Option<crate::models::CreateJobRequest>) -> Result<models::JobResponse, Error<CreateJobError>> {
    let local_var_configuration = configuration;
