...
pub async fn create_service(configuration: &Configuration, create_service_request: Option<crate::models::CreateServiceRequest>) -> Result<models::Service, Error<CreateServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn update_service(configuration: &Configuration, service_id: &str, create_service_request: Option<crate::models::CreateServiceRequest>) -> Result<models::Service, Error<UpdateServiceError>> {
    let local_var_configuration = configuration;
