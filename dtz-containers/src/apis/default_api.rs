...
pub async fn create_job(configuration: &Configuration, create_job: Option<crate::models::CreateJob>) -> Result<models::JobResponse, Error<CreateJobError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&create_job);
